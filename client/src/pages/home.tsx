        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-sm text-gray-600 hover:text-white transition-colors" data-testid="link-privacy">
                {t("footer.privacy")}
              </a>
              <a href="#" className="text-sm text-gray-600 hover:text-white transition-colors" data-testid="link-terms">
                {t("footer.terms")}
              </a>
              <a 
